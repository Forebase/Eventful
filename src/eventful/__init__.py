...
from eventful.exceptions import EventfulError, OptionalDependencyError
...
def emit(event: Event | dict[str, Any] | Any, *, async_: bool | None = None) -> Any:
    """Emit an event through the default local bus."""
...
__all__ = [
    ...
    "set_config", "get_default_bus", "set_default_bus", "emit", "EventfulError",
